...
db_info = {'ibr_cluster_table': get_ibr_cluster_table(initial_date=initial_date,final_date=final_date), 
           ...
           'ibr_3m': get_last_banrep("Indicador Bancario de Referencia (IBR) 3 Meses, nominal",365*5).data[0]['valor']/100,
           'ibr_6m':get_last_banrep("Indicador Bancario de Referencia (IBR) 6 Meses, nominal",365*5).data[0]['valor']/100,
           'ibr_12m':get_last_banrep("Indicador Bancario de Referencia (IBR) 12 Meses, efectiva",365*5).data[0]['valor']/100,
           }
