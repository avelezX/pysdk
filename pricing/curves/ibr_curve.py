...
_TENOR_DEFS = [
    ...
    ("ibr_9m", 9, ql.Months, False),
    ("ibr_12m", 12, ql.Months, False),
    ("ibr_2y", 24, ql.Months, True),
    ("ibr_3y", 36, ql.Months, True),
    ("ibr_3_5y", 42, ql.Months, True),
    ("ibr_4y", 48, ql.Months, True),
    ("ibr_5y", 60, ql.Months, True),
    ("ibr_6y", 72, ql.Months, True),
    ("ibr_7y", 84, ql.Months, True),
    ("ibr_9y", 108, ql.Months, True),
