...
class full_ibr_curve_creation:
    ...
    def crear_curva(self, days_to_on=1, db_info=None):
        OIS_helpers = []

        if db_info is not None:
            OIS_helpers.append(ibr_swap_cupon_helper(db_info['ibr_2y'][0] / 100, 24, ql.Months))
            OIS_helpers.append(ibr_swap_cupon_helper(db_info['ibr_5y'][0] / 100, 60, ql.Months))
            OIS_helpers.append(ibr_swap_cupon_helper(db_info['ibr_10y'][0] / 100, 120, ql.Months))

            OIS_helpers.append(depo_helpers_ibr(db_info['ibr_1d'][0] / 100, 1, ql.Days))
            OIS_helpers.append(depo_helpers_ibr(db_info['ibr_1m'][0] / 100, 1, ql.Months))
            OIS_helpers.append(depo_helpers_ibr(db_info['ibr_3m'][0] / 100, 3, ql.Months))
            OIS_helpers.append(depo_helpers_ibr(db_info['ibr_6m'][0] / 100, 6, ql.Months))
            OIS_helpers.append(depo_helpers_ibr(db_info['ibr_12m'][0] / 100, 12, ql.Months))
